...
private typealias HASH = SHA256
private typealias HMAC = CryptoKit.HMAC
private typealias Nonce = CryptoKit.AES.GCM.Nonce
private typealias PrivateKey = Curve25519.KeyAgreement.PrivateKey
...
@Test
func `tls 1.3 derived`() async throws {
...
@Test
func `tls handshake secret`() async throws {
...
@Test
func `derive handshake traffic secrets`() async throws {
    var hash = SHA256()
...
@Test
func `derive master secret`() async throws {
...
@Test
func `derive client write keys`() async throws {
    let writeKeys = Keys<SHA256>.peerTrafficKeys(
