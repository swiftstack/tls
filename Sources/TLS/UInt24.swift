...
extension UInt24: Numeric {
    var magnitude: UInt24 {
        fatalError("unimplemented")
    }

    static func + (lhs: UInt24, rhs: UInt24) -> UInt24 {
        fatalError("unimplemented")
    }

    static func += (lhs: inout UInt24, rhs: UInt24) {
        fatalError("unimplemented")
    }
